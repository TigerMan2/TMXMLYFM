...
struct TMHomeRecommendModel: HandyJSON {
    var msg: String?
    var ret: Int = 0
    var code: String?
...
struct TMHomeFocusModel: HandyJSON {
    var data: [TMHomeBannerData]?
    var responseId: Int = 0
    var ret: Int = 0
}

struct TMHomeBannerData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
